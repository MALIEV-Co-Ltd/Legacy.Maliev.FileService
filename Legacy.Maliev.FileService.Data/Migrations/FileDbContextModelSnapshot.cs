                    ...
                    b.ToTable("InstantQuoteFinalization", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_InstantQuoteFinalization_QuotationRequestId_Positive", "\"QuotationRequestId\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Legacy.Maliev.FileService.Domain.InstantQuoteUploadFile", b =>
                {
                    ...
                    b.Property<int?>("FinalizedQuotationRequestId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("InstantQuoteUploadFile", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_InstantQuoteUploadFile_FinalizedQuotationRequestId_Positive", "\"FinalizedQuotationRequestId\" IS NULL OR \"FinalizedQuotationRequestId\" > 0");
